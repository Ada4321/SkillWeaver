#!/bin/bash
#SBATCH --job-name=mcts_simpler_spoon_on_towel_vlm
...
# =========================
# simpler / BridgeData WidowX table task: put the spoon on the towel.
...
#   bash data_collect_spoon_on_towel_vlm.sh 1,3,10-12
if [[ "$#" -ge 1 ]] && [[ "$1" != *=* ]]; then
  SCENE_IDS="$1"
  shift
fi
